...
void GaussJordan(matriz & miMatriz)
{
    double mayor; // variable para guardar el mayor valor de la columna i
    ...
    // inicia ciclo for
    int variables = miMatriz.size();
    // se recorre la matriz reducida
    for(int i = 0; i < variables; i++ ){
        mayor = abs(miMatriz[i][i]);
        indice = i;
        // se recorre columna j
        // encontramos el indice mayor
